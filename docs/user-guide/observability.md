...
| -------------------------------------- | --------- | --------------------------------------------------------------------------- |
| seabed:num_requests_running          | Gauge     | Number of requests currently being processed.                               |
| seabed:num_requests_waiting          | Gauge     | Number of requests waiting in the queue.                                    |
| seabed:num_requests_swapped          | Gauge     | Number of requests swapped out to CPU.                                      |
| seabed:prefix_cache_hit_rate         | Gauge     | Prefix cache hit rate.                                                      |
| seabed:kv_cache_usage_ratio          | Gauge     | KV-cache usage ratio. 1.0 means fully used.                                 |
| seabed:prefix_cache_queries          | Counter   | Number of prefix cache queries (total tokens).                              |
| seabed:prefix_cache_hits             | Counter   | Number of prefix cache hits (total tokens).                                 |
| seabed:prompt_tokens                 | Counter   | Total number of prefill tokens processed.                                   |
| seabed:generation_tokens             | Counter   | Total number of generated tokens.                                           |
| seabed:request_prompt_tokens         | Histogram | Number of prefill tokens processed per request.                             |
| seabed:request_generation_tokens     | Histogram | Number of generation tokens processed per request.                          |
| seabed:time_to_first_token_seconds   | Histogram | Time to generate first token.                                               |
| seabed:inter_token_latency_seconds   | Histogram | Time to generate the next token after the previous token has been produced. |
| seabed:time_per_output_token_seconds | Histogram | Time per generated token.                                                   |
| seabed:e2e_request_latency_seconds   | Histogram | End-to-end request latency.                                                 |
| seabed:request_success               | Counter   | Total number of successful requests.                                        |
...
| Metric Name                                      | Type  | Description                                      |
| ------------------------------------------------ | ----- | ------------------------------------------------ |
| seabed:worker_status                           | Gauge | Worker status (with state label).                |
| seabed:worker_node_os                          | Info  | Operating system information of the worker node. |
| seabed:worker_node_kernel                      | Info  | Kernel information of the worker node.           |
| seabed:worker_node_uptime_seconds              | Gauge | Uptime in seconds of the worker node.            |
| seabed:worker_node_cpu_cores                   | Gauge | Total CPU cores of the worker node.              |
| seabed:worker_node_cpu_utilization_rate        | Gauge | CPU utilization rate of the worker node.         |
| seabed:worker_node_memory_total_bytes          | Gauge | Total memory in bytes of the worker node.        |
| seabed:worker_node_memory_used_bytes           | Gauge | Memory used in bytes of the worker node.         |
| seabed:worker_node_memory_utilization_rate     | Gauge | Memory utilization rate of the worker node.      |
| seabed:worker_node_gpu                         | Info  | GPU information of the worker node.              |
| seabed:worker_node_gpu_cores                   | Gauge | Total GPU cores of the worker node.              |
| seabed:worker_node_gpu_utilization_rate        | Gauge | GPU utilization rate of the worker node.         |
| seabed:worker_node_gpu_temperature_celsius     | Gauge | GPU temperature in Celsius.                      |
| seabed:worker_node_gram_total_bytes            | Gauge | Total GPU RAM in bytes.                          |
| seabed:worker_node_gram_allocated_bytes        | Gauge | Allocated GPU RAM in bytes.                      |
| seabed:worker_node_gram_used_bytes             | Gauge | Used GPU RAM in bytes.                           |
| seabed:worker_node_gram_utilization_rate       | Gauge | GPU RAM utilization rate.                        |
| seabed:worker_node_filesystem_total_bytes      | Gauge | Total filesystem size in bytes.                  |
| seabed:worker_node_filesystem_used_bytes       | Gauge | Used filesystem size in bytes.                   |
| seabed:worker_node_filesystem_utilization_rate | Gauge | Filesystem utilization rate.                     |

### Server Metrics

| Metric Name                      | Type  | Description                                       |
| -------------------------------- | ----- | ------------------------------------------------- |
| seabed:cluster                 | Info  | Cluster information (ID, name, provider).         |
| seabed:cluster_status          | Gauge | Cluster status (with state label).                |
| seabed:model                   | Info  | Model information (ID, name, runtime, source).    |
| seabed:model_desired_instances | Gauge | Desired number of model instances.                |
| seabed:model_running_instances | Gauge | Number of running model instances.                |
| seabed:model_instance_status   | Gauge | Status of each model instance (with state label). |
